<template>
  <div class="login-wrap">
    <div class="ms-login" v-if="two">
      ...
      >
        <el-form-item prop="username">
          <el-input v-model="loginParam.username" placeholder="用户名" prefix-icon="el-icon-user"></el-input>
        </el-form-item>
    ...
    <div class="ms-login" v-else>
      ...
      >
        <el-form-item prop="username">
          <el-input v-model="registerParam.username" placeholder="用户名" prefix-icon="el-icon-user"></el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input
            type="password"
        ...
        <el-link type="primary" @click="two = true" style="text-align: center;">去登录 ></el-link>
      </el-form>
    </div>
  </div>
</template>
